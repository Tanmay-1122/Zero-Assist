...
mod tests {
    ...
    fn test_mark_ok_and_snapshot() {
        ...
        let Some(comp) = snap.components.get("test_comp") else {
            panic!("expected 'test_comp' in components");
        };
    ...
    fn test_mark_error() {
        ...
        let snap = snapshot();
        let Some(comp) = snap.components.get("err_comp") else {
            panic!("expected 'err_comp' in components");
        };
    ...
    fn test_bump_restart() {
        ...
        bump_component_restart("restart_comp");
        let snap = snapshot();
        let Some(comp) = snap.components.get("restart_comp") else {
            panic!("expected 'restart_comp' in components");
        };
