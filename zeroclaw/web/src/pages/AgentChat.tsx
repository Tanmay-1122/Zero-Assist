...
import { Send, Square, Bot, User, AlertCircle, Copy, Check, X, Trash2, Minimize2, Maximize2, ChevronDown, Wrench, BarChart2, FolderOpen, Monitor } from 'lucide-react';
  ...
  return (
    ...
    <div translate="no" className="notranslate flex flex-col h-full min-h-0">
      ...
      >
        ...
        {messages
          .filter((msg) => showToolActivity || !msg.toolCall || (msg.toolCall.name === 'canvas' && msg.toolCall.canvasFrame))
          .map((msg, idx) => (
            <MessageItem
              key={msg.id}
              msg={msg}
      ...
      <CanvasSidePanel
        ...
        onCanvasIdChange={setActiveCanvasId}
      />
    </div>
  );
}
