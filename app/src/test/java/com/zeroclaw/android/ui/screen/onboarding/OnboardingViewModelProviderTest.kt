...
private class TestSettingsRepository : SettingsRepository {
    ...
    override suspend fun setMaxToolIterations(max: Int) { /* no-op */ }
    ...
    override suspend fun setTerminalAutoDelegateEnabled(enabled: Boolean) { /* no-op */ }

    override suspend fun setVoiceWakeupRequested(enabled: Boolean) { /* no-op */ }
