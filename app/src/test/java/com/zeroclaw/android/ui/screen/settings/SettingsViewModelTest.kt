...
class SettingsViewModelTest {
    ...
    @Test
    @DisplayName("terminal auto-delegate defaults to false and can be toggled")
    fun `terminal auto-delegate defaults to false and can be toggled`() =
        runTest {
            val repo = TestSettingsRepository()
            assertEquals(false, repo.settings.first().terminalAutoDelegateEnabled)
