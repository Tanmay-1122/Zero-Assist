...
class DataStoreSettingsRepositoryTest {
    ...
    @Test
    @DisplayName("setTerminalAutoDelegateEnabled persists and emits updated value")
    fun `setTerminalAutoDelegateEnabled persists and emits updated value`() =
        runTest {
            val repo = InMemorySettingsRepository()
            repo.setTerminalAutoDelegateEnabled(true)
            assertEquals(true, repo.settings.first().terminalAutoDelegateEnabled)
        }

    @Test
    @DisplayName("setVoiceWakeupRequested persists and emits updated value")
    fun `setVoiceWakeupRequested persists and emits updated value`() =
        runTest {
            val repo = InMemorySettingsRepository()
            repo.setVoiceWakeupRequested(true)
            assertEquals(true, repo.settings.first().voiceWakeupRequested)
        }
...
private class InMemorySettingsRepository : SettingsRepository {
    ...
    override suspend fun setMaxToolIterations(max: Int) {
        _settings.update { it.copy(maxToolIterations = max) }
    }
    ...
    override suspend fun setFallbackProviderConfigsJson(json: String) { /* no-op */ }
    ...
    override suspend fun setGatewayWebDistDir(dir: String) { /* no-op */ }
    ...
    override suspend fun setSecurityWebauthnEnabled(enabled: Boolean) { /* no-op */ }

    override suspend fun setSecurityWebauthnRpId(rpId: String) { /* no-op */ }

    override suspend fun setSecurityWebauthnRpOrigin(rpOrigin: String) { /* no-op */ }

    override suspend fun setSecurityWebauthnRpName(rpName: String) { /* no-op */ }
    ...
    override suspend fun setWorkflowFolderEnabled(enabled: Boolean) { /* no-op */ }

    override suspend fun setWorkflowFolderUri(uri: String) { /* no-op */ }

    override suspend fun setLinuxSandboxEnabled(enabled: Boolean) { /* no-op */ }

    override suspend fun setLinuxSandboxTimeoutSecs(secs: Int) { /* no-op */ }

    override suspend fun setGoogleWorkspaceEnabled(enabled: Boolean) { /* no-op */ }

    override suspend fun setGoogleWorkspaceAllowedServices(services: String) { /* no-op */ }

    override suspend fun setGoogleWorkspaceAuditLog(enabled: Boolean) { /* no-op */ }

    override suspend fun setTermuxEnabled(enabled: Boolean) { /* no-op */ }

    override suspend fun setTermuxPermissionTier(tier: String) { /* no-op */ }

    override suspend fun setTermuxShowTerminalLog(show: Boolean) { /* no-op */ }

    override suspend fun setTermuxPreApprovedPatterns(patterns: String) { /* no-op */ }

    override suspend fun setMcpEnabled(enabled: Boolean) { /* no-op */ }

    override suspend fun setMcpDeferredLoading(enabled: Boolean) { /* no-op */ }

    override suspend fun setMcpServersJson(json: String) { /* no-op */ }
}
