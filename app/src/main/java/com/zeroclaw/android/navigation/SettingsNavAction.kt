...
sealed interface SettingsNavAction {
    ...
    /** Navigate to the Zero-Assist Doctor screen. */
    ...
    /** Navigate to offline voice assistant settings. */
    data object VoiceAssistant : SettingsNavAction
    ...
    /** Navigate to Spotify account linking. */
    data object SpotifyAccount : SettingsNavAction

    /** Navigate to the placeholder skill permissions screen. */
    data object SkillPermissions : SettingsNavAction

    /** Navigate to the on-device LiteRT LM model catalog screen. */
    data object LiteRTModels : SettingsNavAction
}
