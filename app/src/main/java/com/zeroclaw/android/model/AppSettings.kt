...
data class AppSettings(
    ...
    val terminalAutoDelegateEnabled: Boolean = false,
    val voiceWakeupRequested: Boolean = false,
    ...
    val linuxSandboxEnabled: Boolean = false,
    val linuxSandboxTimeoutSecs: Int = DEFAULT_LINUX_SANDBOX_TIMEOUT_SECS,
    val googleWorkspaceEnabled: Boolean = false,
    val googleWorkspaceAllowedServices: String = "",
    val googleWorkspaceAuditLog: Boolean = false,
    val termuxEnabled: Boolean = false,
    val termuxPermissionTier: String = "MEDIUM",
    val termuxShowTerminalLog: Boolean = true,
    val termuxPreApprovedPatterns: String = "",
    ...
    val prootBrowserAllowedDomains: String = "",
    ...
    companion object {
        ...
        /** Default Linux sandbox timeout in seconds (3 hours). */
        const val DEFAULT_LINUX_SANDBOX_TIMEOUT_SECS = 10800
