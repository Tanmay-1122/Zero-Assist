...
/**
     * Supported chat channel types matching upstream Zero-Assist channel configurations.
 *
...
enum class ChannelType(
     ...
     * Webhook channel.
     *
     * **Deprecated in Zero-Assist v0.1.7** — the standalone webhook channel
    ...
    /** MQTT broker listener for SOP trigger events and bidirectional AI chat. */
    MQTT(
        displayName = "MQTT",
        tomlKey = "mqtt",
        fields =
            listOf(
                ...
                ChannelFieldSpec(
                    ...
                    "Client ID",
                    isRequired = true,
                    defaultValue = "zero-assist-android",
                ),
                ChannelFieldSpec(
                    "topics",
                    "Automation Topics",
                ...
                ChannelFieldSpec(
                    "chat_request_topic",
                    "Chat Request Topic",
                    defaultValue = "zeroassist/devices/+/request",
                ),
                ChannelFieldSpec(
                    "chat_response_topic",
                    "Chat Response Topic",
                    defaultValue = "zeroassist/devices/{device_id}/response",
                ),
                ChannelFieldSpec(
                    "chat_payload_mode",
                    "Payload Mode (json/text/auto)",
                    defaultValue = "auto",
                ),
                ChannelFieldSpec(
