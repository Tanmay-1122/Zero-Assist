...
/**
 * Quick Settings tile that toggles the Zero-Assist daemon on and off.
 *
...
class DaemonTileService : TileService() {
    ...
    companion object {
        private const val LABEL_RUNNING = "Zero-Assist: Running"
        private const val LABEL_STOPPED = "Zero-Assist: Stopped"
        private const val LABEL_ERROR = "Zero-Assist: Error"
        private const val LABEL_TRANSITIONING = "Zero-Assist: ..."
    }
}
