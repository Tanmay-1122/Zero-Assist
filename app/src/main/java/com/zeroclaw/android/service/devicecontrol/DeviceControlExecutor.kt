...
class DeviceControlExecutor(
    ...
    private suspend fun executeLoopStep(
        ...
        // ── Snapshot with fingerprint ─────────────────────────────
        val snapStart = trace.beginSnapshot()
        var (screenDesc, fingerprint, cachedNodes) = observer.describeWithFingerprint(service, goal)
    ...
    private suspend fun classifyAndExecuteFastPath(
        ...
        val deterministicAttempt = executeDeterministicKickoff(trimmed, requestId, trace)
