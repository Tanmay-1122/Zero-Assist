...
object ExternalAppLauncher {
     ...
     *
     * Each entry maps a Zero-Assist provider identifier to the web console
    ...
    private val PROVIDER_CONSOLES: Map<String, DeepLinkTarget> =
        mapOf(
            ...
            "xai" to
                DeepLinkTarget(
                    uri = "https://qwen.ai/account/api",
                    label = "Get xAI / Grok API Key",
                ),
            "qwen" to
                DeepLinkTarget(
                    uri = "https://qwen.ai/account/api",
                    label = "Get Qwen API Key",
                ),
        )
