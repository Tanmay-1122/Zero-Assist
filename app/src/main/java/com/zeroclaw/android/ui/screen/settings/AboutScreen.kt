...
fun AboutScreen(
    ...
    var crateVersion by remember { mutableStateOf(AppVersionBridge.UNKNOWN_VERSION) }

    LaunchedEffect(Unit) {
        crateVersion = AppVersionBridge.crateVersionOrFallback()
    }
    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(
                    text = "Built with Zero-Assist, a Rust-native AI agent framework.",
