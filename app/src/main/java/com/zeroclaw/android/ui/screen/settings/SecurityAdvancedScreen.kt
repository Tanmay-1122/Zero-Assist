...
private val OTP_METHODS = listOf("totp", "pairing", "cli-prompt")
...
fun SecurityAdvancedScreen(
    ...
    Column(
        ...
        WebAuthnSection(settings = settings, viewModel = settingsViewModel)
...
private fun WebAuthnSection(
    ...
    SettingsToggleRow(
        ...
        subtitle = "Turn on hardware key / platform authenticator support",
        checked = settings.securityWebauthnEnabled,
        onCheckedChange = { viewModel.updateSecurityWebauthnEnabled(it) },
        contentDescription = "Enable passkey authentication",
    )

    OutlinedTextField(
        value = settings.securityWebauthnRpId,
        onValueChange = { viewModel.updateSecurityWebauthnRpId(it) },
        label = { Text("Relying party ID") },
        supportingText = { Text("Usually your host/domain (e.g. localhost)") },
        enabled = settings.securityWebauthnEnabled,
        singleLine = true,
        modifier = Modifier.fillMaxWidth(),
    )

    OutlinedTextField(
        value = settings.securityWebauthnRpOrigin,
        onValueChange = { viewModel.updateSecurityWebauthnRpOrigin(it) },
        label = { Text("Relying party origin") },
        supportingText = { Text("Origin URL used during passkey registration/auth") },
        enabled = settings.securityWebauthnEnabled,
        singleLine = true,
        modifier = Modifier.fillMaxWidth(),
    )
    ...
    OutlinedTextField(
        value = settings.securityWebauthnRpName,
        onValueChange = { viewModel.updateSecurityWebauthnRpName(it) },
        label = { Text("Relying party name") },
        supportingText = { Text("Display name shown by authenticator UI") },
        enabled = settings.securityWebauthnEnabled,
        singleLine = true,
        modifier = Modifier.fillMaxWidth(),
    )
