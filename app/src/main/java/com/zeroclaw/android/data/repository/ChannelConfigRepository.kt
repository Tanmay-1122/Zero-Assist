...
interface ChannelConfigRepository {
    ...
    /**
     * Returns the configured channel for [type], or null if none exists.
     *
     * @param type Channel type to load.
     * @return The matching [ConnectedChannel], or null.
     */
    suspend fun getByType(type: ChannelType): ConnectedChannel?
    ...
    /**
     * Sets the enabled state of the channel with the given [id].
     *
     * @param id Unique channel identifier.
